...
!@@ Arrays for convergence:
real(mytype), save, allocatable, dimension(:,:,:) :: uxR1_p,uyR1_p,uzR1_p
...
!@@ Convergence arrays
    call alloc_x(uxR1_p, opt_global=.true.)
	uxR1_p = zero
    call alloc_x(uyR1_p, opt_global=.true.)
	uyR1_p = zero
    call alloc_x(uzR1_p, opt_global=.true.)
	uzR1_p = zero
