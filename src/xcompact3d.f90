...
program xcompact3d
  ...
  call readProbes_p				! Tolstoy - Probes
  
  !call setupBuffer_p			! Buffer
  
!@@ Convergence set reference velocites
!uxR1_p = ux1; uyR1_p = uy1; uzR1_p = uz1
  ...
  do itime=ifirst,ilast
	 ...
	 !ta1 = ux1; tb1 = uy1; tc1 = uz1;
	 !call buffcomputeTriFilteredVar(ta1)
	 !call buffcomputeTriFilteredVar(tb1)
	 !call buffcomputeTriFilteredVar(tc1)
	 !ux1(ixBuffPosn_p:nx,:,:) = ta1(ixBuffPosn_p:nx,:,:);
	 !uy1(ixBuffPosn_p:nx,:,:) = tb1(ixBuffPosn_p:nx,:,:);
	 !uz1(ixBuffPosn_p:nx,:,:) = tc1(ixBuffPosn_p:nx,:,:); 
	 ...
	 call probes_p(ux1,uy1,uz1,itime)			! Tolstoy - Probes
	 
	 !if (mod(itime,convModulo_p)==0) then
	 !  call conv_p(itime,dt,convVelDiff_p,ux1,uy1,uz1,uxR1_p,uyR1_p,uzR1_p,ta1)
	 !endif
