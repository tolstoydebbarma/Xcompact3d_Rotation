...
!!!
	...
	elseif (itype.eq.itype_pipe_TD) then
       ...
       !call init_pipe_TD(ux1, uy1, uz1, ep1, phi1)
	
	elseif (itype.eq.itype_jet_TD) then

       call init_jet_TD(ux1, uy1, uz1, phi1)
	   
	elseif (itype.eq.itype_chk_buffer) then

       call init_chk_buff(ux1, uy1, uz1, phi1)
	
	elseif (itype.eq.itype_jet_nonozzle) then

       call init_jet_nonozzle(ux1, uy1, uz1, phi1)
  ...
  subroutine boundary_conditions (rho,ux,uy,uz,phi,ep)
	...
	elseif (itype.eq.itype_jet_TD) then
       ...
       call boundary_conditions_jet_TD (ux, uy, uz, phi)
	
	elseif (itype.eq.itype_chk_buffer) then

       call boundary_conditions_chk_buff (ux, uy, uz, phi)
	
	elseif (itype.eq.itype_jet_nonozzle) then

       call boundary_conditions_jet_nonozzle (ux, uy, uz, phi)
  ...
  subroutine preprocessing(rho1, ux1, uy1, uz1, pp3, phi1, ep1)
	...
	integer :: num			! Tolstoy added
	
    call write_snapshot(rho1, ux1, uy1, uz1, pp3, phi1, ep1, itime, num)
	call end_snapshot(itime, num)									! Tolstoy added
  ...
  subroutine postprocess_case(rho,ux,uy,uz,pp,phi,ep)
	...
	elseif (itype.eq.itype_jet_TD) then
       ...
       call postprocess_jet_TD(ux, uy, uz, pp, phi, ep)
